...
ansible-playbook -i ../ansible/hosts ../ansible/playbooks/python_setup.yml --private-key=~/.ssh/latest_jrich_key --ssh-common-args='-o ForwardAgent=yes' --become
ansible-playbook -i ../ansible/hosts ../ansible/playbooks/postgres_setup.yml --private-key=~/.ssh/latest_jrich_key --ssh-common-args='-o ForwardAgent=yes' --become-user=postgres
